// js/ui.js
export function setupTools(gameState, canvas) {
    ...
    toolButtons.forEach(button => {
        button.addEventListener('click', () => {
            ...
            // ALTERADO: Muda o cursor do mouse
...
export function updateStats(gameState) {
    document.getElementById('dinheiro-valor').textContent = Math.floor(gameState.money);
